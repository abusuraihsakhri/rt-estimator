"""
Command Line Interface for Rt Estimator.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="rt-estimator", description="Rt Estimator")
    ...
    if args.command == "serve":
        ...
        print(f"Starting Rt Estimator API server on http://{args.host}:{args.port}")
