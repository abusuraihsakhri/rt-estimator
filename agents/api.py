"""
FastAPI REST API Server for Rt Estimator.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "rt-estimator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
